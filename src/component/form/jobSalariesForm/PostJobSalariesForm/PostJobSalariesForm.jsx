...
import { postAddJobSalaries } from '../../../../redux/jobSalaries/postSalaries/actions';
...
const PostJobSalariesForm = ({ onClose, postAddJobSalaries, loading, error, success, position }) => {  
...
const mapStateToProps = (state) => ({ 
    loading: state.postSalaries.loading,
    error: state.postSalaries.error,
    success: state.postSalaries.success,
...
export default connect(mapStateToProps, mapDispatchToProps)(PostJobSalariesForm);
